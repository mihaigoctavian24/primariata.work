      ...
      heroContent={
        <div className="flex h-full flex-col items-center justify-center space-y-8 px-8">
          ...
          >
            ...
            >
              Creează-ți cont pentru a accesa toate serviciile
            </p>
          </motion.div>
    ...
    >
      ...
      <div className="flex min-h-screen items-center justify-center p-4 sm:p-6 lg:p-8">
        <AnimatedCard delay={0.6} glassEffect className="w-full max-w-md space-y-8">
          ...
          >
            <h2 className="text-3xl font-bold tracking-tight">Creează cont</h2>
            <p className="text-muted-foreground text-sm">Completează datele tale pentru a începe</p>
          </motion.div>
