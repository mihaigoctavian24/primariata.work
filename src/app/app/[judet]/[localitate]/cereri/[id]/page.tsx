...
export default function CerereDetailsPage({ params }: CerereDetailsPageProps) {
  ...
  return (
    <div className="container mx-auto max-w-4xl space-y-6 p-6">
      ...
      {/* Status Timeline - To be implemented */}
      <Card>
        <CardHeader>
          <CardTitle>Starea cererii</CardTitle>
        </CardHeader>
        <CardContent>
          <p className="text-muted-foreground text-sm">Timeline component - Coming soon</p>
        </CardContent>
      </Card>
        ...
        <CardContent className="space-y-4">
          ...
          {cerere.observatii_solicitant && (
            <>
              <Separator />
              <div>
                <dt className="text-muted-foreground text-sm font-medium">Observații solicitant</dt>
                <dd className="mt-1 text-sm whitespace-pre-wrap">{cerere.observatii_solicitant}</dd>
              </div>
            </>
          )}
        </CardContent>
