  ...
  return (
    <div className="bg-background flex min-h-screen flex-col items-center justify-center p-4">
      <div className="max-w-md space-y-4 text-center">
        <h2 className="text-2xl font-bold text-red-600 dark:text-red-400">A aparut o eroare</h2>
        <p className="text-gray-600 dark:text-gray-300">
          Ne cerem scuze pentru inconvenient. Echipa noastra a fost notificata automat.
        </p>
        {error.digest && (
