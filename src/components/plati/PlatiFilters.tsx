 ...
 * Provides advanced filter controls for the plati list
 *
 * Features:
 * - Search by numar_plata or referinta (debounced)
...
export function PlatiFilters({
  ...
  const activeFilterCount = [search, status, dateFrom, dateTo, sortBy !== "created_at_desc"].filter(
    Boolean
  ).length;
  ...
  const sortOptions = [
    ...
    { value: "suma_desc", label: "Sumă (descrescător)" },
    { value: "suma_asc", label: "Sumă (crescător)" },
    ...
    <div className={cn("space-y-4", className)}>
      ...
      <div className="flex flex-col gap-3 md:flex-row md:items-center">
        ...
        <div className="relative flex-1 md:max-w-xs">
          ...
          <Input
            type="text"
            placeholder="Caută după număr plată sau referință..."
            value={search || ""}
      ...
      {/* Secondary Filter Bar - Active Filters Badge and Reset Button */}
      {activeFilterCount > 0 && (
