...
description: Platformă SaaS white-label pentru digitalizarea primăriilor din România
---
...
[![Documentation](https://img.shields.io/badge/docs-72%25-yellow)](https://github.com/mihaigoctavian24/primariata.work)
...
```mermaid
gantt
    title Documentație Primăriata - Progress
    dateFormat YYYY-MM-DD
    section 01-Prezentare
    Completat (6/6)        :done, 2025-10-01, 2025-10-30
    section 02-Cerinte
    Completat (5/5)        :done, 2025-10-01, 2025-10-30
    section 03-Arhitectura
    Completat (6/6)        :done, 2025-10-01, 2025-10-30
    section 04-Implementare
    Stack-Tehnologic (1/4) :done, 2025-10-30, 1d
    Remaining (3/4)        :active, 2025-11-01, 2025-11-15
    section 05-Utilizare
    Toate (0/4)            :active, 2025-11-01, 2025-11-20
    section 06-Anexe
    Toate (0/4)            :active, 2025-11-15, 2025-11-29
```
...
![Sentry](https://img.shields.io/badge/Sentry-Monitoring-purple?logo=sentry)
...
![Jest](https://img.shields.io/badge/Jest-29.x-red?logo=jest)
![Playwright](https://img.shields.io/badge/Playwright-E2E-green?logo=playwright)
![Testing Library](https://img.shields.io/badge/Testing-Library-red?logo=testing-library)
...
[![Website](https://img.shields.io/badge/Website-primariata.work-blue?style=for-the-badge&logo=google-chrome)](https://primariata.work)
[![GitHub](https://img.shields.io/badge/GitHub-Repository-black?style=for-the-badge&logo=github)](https://github.com/mihaigoctavian24/primariata.work)
[![Documentation](https://img.shields.io/badge/Docs-GitHub_Pages-green?style=for-the-badge&logo=read-the-docs)](https://mihaigoctavian24.github.io/primariata.work/)
